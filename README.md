...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-22 17:49`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b24a91f7-496e-4a71-9e36-16c50a6f91fe.git
$ cd b24a91f7-496e-4a71-9e36-16c50a6f91fe
```
